  ...
  const handleGenerateForm = async () => {
    ...
    try {
      ...
      const notificationData = {
        user_id: 1, // Replace with actual user ID or retrieve from context
        message: `Advance form generated successfully for group ID ${groupId}`,
            ...
            <div className="table">
              ...
              {advances.map((advance) => (
                <div className="table-row" key={advance.id}>
                  ...
                  <div>${advance.initial_amount.toFixed(2)}</div>
                  <div>${advance.payment_amount.toFixed(2)}</div>
                  ...
                  <div>${advance.paid_amount.toFixed(2)}</div>
                  <div>${advance.total_amount_due.toFixed(2)}</div>
